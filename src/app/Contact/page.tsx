    ...
    <div>
      ...
      <div className="container mx-auto p-6">
        ...
        <p className="text-lg text-justify mb-6 leading-relaxed">
          I&apos;m always open to discussing new projects, creative ideas, or opportunities to be part of your vision. Feel free to reach out through any of the contact methods listed below.
        </p>
